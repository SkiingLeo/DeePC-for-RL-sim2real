...
# Pre-defined configs
##
from isaaclab_assets import FRANKA_PANDA_CFG, FRANKA_PANDA_REAL_CFG  # isort: skip
...
class FrankaReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot = FRANKA_PANDA_REAL_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        # override rewards
