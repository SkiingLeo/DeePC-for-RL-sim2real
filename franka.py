...
"""Jan's REAL robot config"""

FRANKA_PANDA_REAL_CFG = FRANKA_PANDA_CFG.copy()
FRANKA_PANDA_REAL_CFG.spawn.rigid_props.disable_gravity = True
FRANKA_PANDA_REAL_CFG.actuators = {
    "panda_joint1": IdealPDActuatorCfg(
    ...
    "panda_joint2": IdealPDActuatorCfg(
    ...
    "panda_joint3": IdealPDActuatorCfg(
    ...
    "panda_joint4": IdealPDActuatorCfg(
    ...
    "panda_joint5": IdealPDActuatorCfg(
    ...
    "panda_joint6": IdealPDActuatorCfg(
    ...
    "panda_joint7": IdealPDActuatorCfg(
    ...
    joint_names_expr=["panda_finger.*"],  # Match the joint names used in the env config
    effort_limit=100,
    velocity_limit=0.1,
    stiffness=1200,
    damping=70
